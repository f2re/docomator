  ...
  const helpCenterArticles = [
    {
      ...
      view: "overview",
      body: `
        <p>Рабочий поток «Оформлятора» состоит из данных, проверенного шаблона, зафиксированного состава и задания на формирование.</p>
        <ol>
...
Иванов Иван Иванович\tТ-001\tИнженер\tМетеослужба\t1985-05-10</code></pre>
    ...
    },
    {
      ...
      body: `
        ...
        <ul>
          <li>Оформлятор распознаёт стандартные и пользовательские форматы дат.</li>
...
npm run restore</code></pre>
    ...
    },
    {
      ...
      body: `
        <ul>
          <li>Оформлятор не следует публиковать напрямую в Интернет.</li>
