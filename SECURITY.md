...
Статус проекта: `0.1.0-alpha.0`. До завершения целевой приёмки, восстановления резервной копии и проверки реальных документов Docomator нельзя использовать для штатной обработки персональных или ограниченных данных.
