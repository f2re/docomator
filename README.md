...
4. Служебный лист `_AI_META` для XLSX по обязательному требованию `TPL-006`.
5. Поиск физических объектов, отсутствующих в SQLite.
6. Повторяемые списки DOCX, несколько строк XLSX и более сложные структурные области.
7. Предметные события.
8. Локальные агенты ИИ — после стабилизации детерминированного пути.
