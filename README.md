...
Автономный корпоративный сервис формирования DOCX/XLSX по шаблонам и типизированным данным. Runtime работает без обязательного доступа в Интернет. Доступ к рабочему интерфейсу и предметным API закрывается **одним общим паролем Docomator**.
