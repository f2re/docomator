...
Рекомендуемый порядок:
  ...
  10. 📌 Выберите будущую область заполнения.
      Сейчас выбор помогает проверить координату. Следующий этап сохранит название, тип и привязку поля.
...
Что появится следующим этапом:
  ...
  ⏳ техническая привязка DOCX/XLSX и пробное скалярное заполнение;
