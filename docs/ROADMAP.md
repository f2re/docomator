...
- [ ] единый словарь отображения типов, ролей, состояний и режимов в веб-интерфейсе;
- [ ] перевод оставшихся подсказок и технических подписей;
- [ ] включение помощника первого запуска в автономный комплект;
- [ ] запуск помощника после успешной установки;
- [ ] очистка временных сценариев синхронизации;
- [ ] успешная полная проверка и слияние этапа.

## Следующий приоритет

После завершения M1.7 начинается M2 без участия локальной модели:
...
- `0.1.x` — основа, детерминированное ядро, пространства и аудитории;
