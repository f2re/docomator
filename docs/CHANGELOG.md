...
- Переключатель согласован с новой визуальной иерархией верхней панели и адаптивным представлением строк DOCX.
- Перед слиянием успешно выполнены полный `npm run check`, миграция чистой базы и Chromium-набор пользовательских сценариев.
