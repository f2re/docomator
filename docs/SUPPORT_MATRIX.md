...
- настройка 4-значного кода доступа без логина, вход, локальный recovery `first-run.sh --reset-code` и подтверждение завершения старой сессии;
...
Свидетельства `0.1.0`, `0.2.x`, `0.3.x`, `0.4.0`, `0.5.0`, `0.5.1`, `0.5.2`, `0.5.3`, `0.6.0` и `0.6.1` исторические и не закрывают матрицу `0.6.2`: акт должен совпадать с текущими version, status/channel, commit и SHA-256 release metadata.
