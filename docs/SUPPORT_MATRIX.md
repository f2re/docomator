...
Акты `0.1.x—0.6.6` остаются историческими и **не закрывают** acceptance `0.6.7`. Изменение UX выпуска требует нового evidence exact `0.6.7`, даже при неизменной security boundary ADR-0011.
